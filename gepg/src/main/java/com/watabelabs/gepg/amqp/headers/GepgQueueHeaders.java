...
public class GepgQueueHeaders {
    ...
    public static final String BILL_CANCELLATION_HEADER = "BILL_CANCELLATION_REQUEST_HEADER ";
    public static final String PAYMENT_SUBMISSION_HEADER = "PAYMENTS_REQUEST_HEADER ";
    public static final String RECONCILIATION_SUBMISSION_HEADER = "RECONCILIATION_SUBMISSION_REQUEST_HEADER ";
}
